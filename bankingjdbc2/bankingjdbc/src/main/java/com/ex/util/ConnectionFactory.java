...
public class ConnectionFactory {
	/* we use this class to generate our
	 * connections to our DB. it leverages
	...
	public Connection getConnection() {
		...
		String path = "C:/Users/Sharjeel Tahir/Desktop/bankingjdbc2/bankingjdbc/src/main/resources/application.properties";
		try {
			//load properties file
			prop.load(new FileReader(path));
			// .forName returns the Class object which can be instantiated with .newInstance() method
			// .forName creates the object of that class
